...
[旧商品データ]テーブルのカテゴリー情報から、階層構造の[カテゴリーデータ]テーブルを生成する部分については、[別途要件](./docs/feature/create_category/README.md.md)が定められているため、そちらを加味した上で設計する
